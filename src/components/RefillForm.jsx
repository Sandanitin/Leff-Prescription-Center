    ...
    return (
        <div id="refill-form">
            <div className="mb-6 text-center">
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Request Prescription Refill</h2>
                <p className="text-gray-500">Hassle-free online refill requests - ready in 10-15 minutes</p>
            </div>
